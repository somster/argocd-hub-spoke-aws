...
- Orchestrating multi-module hierarchical architectures (layered module patterns)
...
3. **Orchestrate layers** - Organize independent modules hierarchically (shared → identity → compute)
...
6. **Test and validate** - Run terraform plan, policy checks, automated tests
...
| Module Orchestration | `references/module-orchestration.md` | Multi-module hierarchical designs, layered orchestration patterns |
